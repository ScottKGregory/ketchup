...
export default function Navbar(props: Props) {
  return (
    <nav className="sticky start-0 top-0 z-20 w-full border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="mx-auto flex max-w-(--breakpoint-2xl) flex-wrap items-center justify-between p-4">
                ...
                <Typography type="span">
                  ...
                  <a
                    ...
                    className={classNames({
                      "text-primary-600 block rounded-xs bg-transparent p-0":
                        link.active,
                      "hover:text-primary-600 block rounded-xs p-0 text-gray-900 dark:text-gray-100":
                        !link.active,
                    })}
                  >
                    {link.title}
